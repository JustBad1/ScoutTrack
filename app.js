...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialise GPX functionality
    initialiseGPX();
    
    // Initialie Strava functionality
    initialiseStrava();
});
...
async function saveActivity(e) {
    ...
    const requiredIds = ["activity-date","activity-type","activity-name","duration","distance","elevation","nights","role","category","weather","start-location","end-location","comments"];
